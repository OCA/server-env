...
class TestPreserveNotEnvManagedData(common.ServerEnvironmentCase):
    ...
    def remove_mixin_fields(self):
        ...
        It never touches non-field attributes (e.g. _inverse_server_env_city).
        """
        for model in ("res.partner", "res.users"):
    ...
    def setUp(self):
        ...
        # populate city_env_default through the mixin's inverse method,
    ...
    def test_preserve_rescues_value_when_no_default_yet(self):
        ...
        self.assertEqual(self.partner.city_env_default, "Legacy Raw City")
    ...
    def test_preserve_does_not_overwrite_existing_default(self):
        ...
        self.assertEqual(self.partner.city_env_default, "Current Default City")
